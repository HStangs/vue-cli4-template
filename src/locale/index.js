...
const messages = {
  "zh-CN": { ...elZhCnLang, ...customZhCn },
  "zh-TW": { ...elZhTwLang, ...customZhTw },
  "en-US": { ...elEnLang, ...customEnUs }
};
Vue.use(VueI18n);
const languages = ["zh-CN", "zh-TW", "en-US"];

const language = languages.includes(SessionStorage.getItem("language")) ? SessionStorage.getItem("language") : "zh-CN";
